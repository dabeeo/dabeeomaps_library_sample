  ...
  createComputingPrimitives(data, userInput, viewerParameters) {
    ...
    this.primitives = {
      ...
      updateSpeed: new CustomPrimitive({
        ...
        fragmentShaderSource: new Cesium.ShaderSource({
          sources: [
            Util.loadText(fileOptions.glslDirectory + "updateSpeed.frag"),
          ],
        }),
      ...
      updatePosition: new CustomPrimitive({
        ...
        fragmentShaderSource: new Cesium.ShaderSource({
          sources: [
            Util.loadText(fileOptions.glslDirectory + "updatePosition.frag"),
          ],
        }),
      ...
      postProcessingPosition: new CustomPrimitive({
        ...
        fragmentShaderSource: new Cesium.ShaderSource({
          sources: [
            Util.loadText(
              fileOptions.glslDirectory + "postProcessingPosition.frag"
            ),
          ],
        }),
      ...
      postProcessingSpeed: new CustomPrimitive({
        ...
        fragmentShaderSource: new Cesium.ShaderSource({
          sources: [
            Util.loadText(
              fileOptions.glslDirectory + "postProcessingSpeed.frag"
            ),
          ],
        }),
