...
export class Wind3D {
  ...
  async setTileset() {
    const assetsList = [
      ...
      // 2387803, 2387804, 2387805, 2387806,  2387855, 2387856, 2387858,
  ...
  getMaxNumByHeight(viewHeight) {
    ...
    if (viewHeight > 20000000) {
      ...
      return Math.ceil(k * viewHeight + 180);
    } else if (viewHeight > 500) {
      return Math.ceil(k * viewHeight + 150);
    } else {
      return Math.ceil(k * viewHeight + 100);
    }
  }
