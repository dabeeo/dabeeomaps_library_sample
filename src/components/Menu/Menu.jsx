    ...
    return(
        <div className={styles.menu}>
            ...
            <ul className={styles.lists} id='lists'>
                ...
                <li className={styles.listItem} data-link='navigation' onClick={onLink}>{ lang === 'ko' ? '길찾기와 경로 텍스트' : 'Navigation'}</li>
                <li className={styles.listItem} data-link='marker' onClick={onLink}>{ lang === 'ko' ? '마커 표시하기' : 'setMarker'}</li>
                <li className={styles.listItem} data-link='mylocation' onClick={onLink}>{ lang === 'ko' ? '내 위치(GPS) 표시' : 'myLocationOn'}</li>
                <li className={styles.listItem} data-link='domTag' onClick={onLink}>{ lang === 'ko' ? 'HTML Element 표시' : 'make HTML Element'}</li>
