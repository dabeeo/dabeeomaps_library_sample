    ...
    return (
        <div className={styles.navigationText}>
            ...
            <div className={styles.miniTitle}>
                지도에 출발지에서 목적지까의 경로를 그리고, 경로에 대한 안내를 텍스트로 표시하며, 모의주행을 실행할 수 있습니다.
            </div>
            <p>
                경로를 그리기 위해서는 먼저 경로를 찾아야 합니다. 아래의 순서대로 이용해야 합니다.
                <br />
                1. 경로를 먼저 구합니다. <br />
                ...
                2.1 경로요청에 대한 응답중에 경로를 텍스트로 설명한 정보가 있습니다. 이를 이용하여 경로에 대한 설명을 표시할 수 있습니다. (예: 10m 후 좌회전){' '}
                <br />
            ...
            <div className={styles.texts}>
                해당 목적지까지의 경로를 받은 후에 경로를 지도에 그리는 예제는 간단히 아래와 같습니다. 경로를 구하는 위해 서버에 접속하게 되므로 비동기방식으로
                호출됩니다.{' '}
            </div>
            <pre>
