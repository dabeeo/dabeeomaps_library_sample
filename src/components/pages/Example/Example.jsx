        ...
        <div className={styles.example}>
            ...
            <div className={styles.body}>
                <ul id="lists" className={styles.lists}>
                    <li onClick={onClick} style={{ backgroundColor: 'black', color: 'white', fontWeight: 'bold' }}>
                        getStarted
                    </li>
            ...
            <a className={styles.viewCode} href={`https://github.com/dabeeo/dabeeomaps_library_sample/blob/master/Examples/${link}/index.html`} target="_blank">
                코드로 보기
            </a>
        </div>
    );
