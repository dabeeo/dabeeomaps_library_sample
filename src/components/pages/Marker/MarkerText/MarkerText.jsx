    ...
    return (
        <div className={styles.markerText}>
            ...
            <p>
                ...
                여러 개의 마커를 지정하기 위하여 배열 형태로 인자를 받습니다.<br /><br />
                중요! 마커 생성시 비동기 방식으로 호출시 아이디가 중복될 수 있습니다. 동기 방식으로 호출해야 고유한 아이디 반환이 보장됩니다.<br /><br />
                개별적으로 마커를 삭제하기 위해서는 생성시 마커의 아이디를 받아 아이디를 지정해야 합니다. <br />
                한층에만 마커를 그릴 경우에는 층정보를 생략하나, 여러층에 한꺼번에 마커를 표시하고자하는 경우는 각 마커에 층아이디를 지정합니다.<br />
                마커의 속성은 아래 예제와 같습니다.
            </p>
            <pre>
