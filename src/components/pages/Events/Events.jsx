...
const Events = () => {
    return (
        <div className={styles.events}>
            ...
            <code className={styles.code}>{`mapContainer.addEventListener("will-floor-change", (e) => console.log(e.detail));`}</code>
            ...
            <code className={styles.code}>{`mapContainer.addEventListener("redrawed-map", (e) => console.log(e.detail));`}</code>
